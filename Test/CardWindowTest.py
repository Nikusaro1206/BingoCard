...
class Main_aplication(tk.Frame):
    def __init__(self,root=None):
        ...
        self.root = root
        self.pack()
        self.card = [14, 2, 7, 1, 5, 19, 24, 21, 29, 23, 36, 45, 0, 44, 32, 60, 51, 52, 50, 58, 67, 68, 75, 69, 62]
        self.hush_number = []
...
card = [14, 2, 7, 1, 5, 19, 24, 21, 29, 23, 36, 45, 0, 44, 32, 60, 51, 52, 50, 58, 67, 68, 75, 69, 62]
current=tk.Tk()
current.title(f"test")
